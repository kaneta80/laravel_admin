                    ...
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <div v-if="errors.kana" class="text-red">*{{ errors.kana }}</div>
                            </div>
                            </div>
                            <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <div v-if="errors.tel" class="text-red">*{{ errors.tel }}</div>
                            </div>
                            </div>
                            <div class="p-2 w-full">
                            <div class="relative">
                            ...
                            <div class="relative">
                                ...
                                <div v-if="errors.address" class="text-red">*{{ errors.address }}</div>
                            </div>
                            </div>
                            <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <div v-if="errors.birthday" class="text-red">*{{ errors.birthday }}</div>
                            </div>
                            </div>
                            <div class="p-2 w-full">
                                  <div class="relative">
                                  ...
                                  <div v-if="errors.gender" class="text-red">*{{ errors.gender }}</div>
                            </div>
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    <label for="memo" class="leading-7 text-sm text-gray-600">メモ</label>
                                    <textarea id="memo" name="memo" v-model="form.memo" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                    <div v-if="errors.memo" class="text-red">*{{ errors.memo }}</div>
                                  </div>
                                </div>
                            <div class="p-2 w-full">
